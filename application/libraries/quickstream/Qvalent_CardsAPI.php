...
// 
// Modifcations:
// 2015.10.06 MD CURLOPT_SSL_VERIFYHOST changed from 1 to 2 due to curl version
// 2015.10.06 MD split replaced by explode function as it is deprecated starting in php version 5.3 
// -------------------------------------------------------------------------
...
class Qvalent_CardsAPI
{
    ...
    function _parseResponseParameters( $parametersString )
    {
        ...
        $parameterArray = explode( "\r\n", $parametersString ); //2015.10.06 split replaced by explode
	$props = array();
		...
		list( $paramName, $paramValue ) = explode( "=", $parameter );//2015.10.06 split replaced by explode
	...
	curl_setopt( $ch, CURLOPT_SSL_VERIFYHOST, 2 );//2015.10.06 curl requires at least 2 
