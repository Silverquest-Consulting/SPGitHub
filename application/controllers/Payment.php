...
class Payment extends CI_Controller{ 
	...
	var $initialised;
	var $caFile;
	var $trace;        // for test only
	var $execute_curl; // for test only
    ...
    public function Qvalent_CardsAPI()
    {
    	$this->url = NULL;
    	$this->logDirectory = NULL;
    	$this->initialised = false;
    	$this->trace = false; // true for test only
    	$this->execute_curl = true; //false for test only
    }
    ...
    */
    ...
    {
    	if ( $this->trace == true ) {
    		echo "In handleInitialisationFailure <br>";
    		print_r( $message );
    	}
     ...
     */
    public function _parseResponseParameters( $parametersString )
    {
    	if ( $this->trace == true ) {
    		echo "In _parseResponseParameters <br>";
    		print_r( $parametersString );
    	}
     ...
     *   function.
     */
    public function _formatRequestParameters( $parametersArray )
    {
    	...
    	if ( $this->trace == true ) {
    		echo "In _formatRequestParameters <br>";
    		print_r( $parametersString );
    	}
     ...
     */
    public function processCreditCard( $requestParameters )
    {
    	if ( $this->trace == true ) {
    		echo "In processCreditCard <br>";
    	...
    	if ( $this->execute_curl == false ) {
    		echo "In processCreditCard .. Curl NOT execute .. returning null .. <br>";
     ...
     */
    public function _getOrderNumber( $parameters )
    {
    	if ( $this->trace == true ) {
    		echo "In _getOrderNumber <br>";
    		print_r( $parameters[ "customer.orderNumber" ] );
    	}
    ...
    * error occurs.
    */
    public function _getResponse( $summaryCode, $responseCode, $responseText )
    {
    	if ( $this->trace == true ) {
    		echo "In _getResponse <br>";
    		print_r($summaryCode);
    		echo " <br> ";
    ...
    */
    public function _getMessageForLogging( $parameters )
    {
    	//if ( $this->trace == true ) {
    	//	echo "In _getMessageForLogging <br>";
    	//	print_r($parameters);
    	//}
    ...
    */
    ...
    {
    	if ( $this->trace == true ) {
    		echo "In _formatCardNumberForDisplay <br>";
    		print_r($cardNumber);
    	}
    ...
    */
    ...
    public function index(){ 
    	...
    	//$this->load->library('Qvalent_CardsAPI');
    	...
    	$initParams[ "logDirectory" ] = '/var/www/vhosts';
    	/* $cardsAPI = new CI_Qvalent_CardsAPI();
    	$cardsAPI->initialise( $initParams ); */
    	$cardsAPI=$this->initialise($initParams);
